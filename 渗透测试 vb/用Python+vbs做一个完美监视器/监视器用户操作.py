...
# os.system("WSCRIPT hellow.vbs")#运行批处理文件
# os.system("CSCRIPT hellow.vbs")#运行批处理文件
os.system("CSCRIPT hellow.js")
...
　　rundll32
user32.dll, LockWorkStation：表示锁定计算机
...
　　45.
mem.exe：显示内存使用情况(如果直接运行无效，可以先管理员身份运行命令提示符，在命令提示符里输入mem.exe > d: a.txt
