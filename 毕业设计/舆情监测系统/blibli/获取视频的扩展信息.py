# _*_coding:utf_8_*_
# 代码仓库 was created by zy on 2022/3/10 11:08
import requests as r
import re
import json
"""
aid、bvid、view(视频播放数)、danmaku(总弹幕数)、reply(评论数)、share(分享数)、like(点赞数)、favorite(收藏)、coin(投币数
"""
...
if __name__ == '__main__':
    # 以下代码用于测试
    info = getExtraInfo("BV1eb4y1W7Uj")
    print(info)